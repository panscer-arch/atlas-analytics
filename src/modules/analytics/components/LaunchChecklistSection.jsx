...
const STATIC_BOARD_IDS = ["launch", "knowledgeBase", "ideas", "dailyTasks", "videoScripts", "materials", "productLibrary", "agentTasks", "agentDataset", "agentFaq", "ceoPresentation", "terminology", "marketing"];
...
function LaunchChecklistSection({ mode = "tasks" }) {
  ...
  const isStaticContentBoard = isDailyTasksBoard || isVideoScriptsBoard || isMaterialsBoard || isProductLibraryBoard || isAgentTasksBoard || isAgentDatasetBoard || isAgentFaqBoard || isCeoPresentationBoard || isTerminologyBoard;
