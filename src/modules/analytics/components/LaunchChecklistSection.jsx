...
const STATIC_BOARD_IDS = ["launch", "knowledgeBase", "ideas", "materials", "agentTasks", "agentFaq", "ceoPresentation"];
const STATIC_BOARD_META = {
  ...
  ceoPresentation: {
    ...
    description: "Согласованные 13 слайдов: визуальное ТЗ и текст Архитектора для production-ролика.",
  },
};
  ...
  return (
    <>
      <section className="analytics-surface analytics-tab-summary mt-4">
        ...
        {!isMaterialsBoard && !isAgentTasksBoard && !isAgentFaqBoard && !isCeoPresentationBoard ? (
