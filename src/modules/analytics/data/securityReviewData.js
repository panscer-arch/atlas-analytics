...
export const AUDITOR_COMPANIES_STORAGE_KEY = "atlas.analytics.auditCompanies.v4";
...
export const defaultAuditorCompanies = [
  { id: "interfi-network", name: "InterFi Network", country: "International / budget segment", region: "Global", site: "https://www.interfi.network", contact: "Форма на сайте", budget: "$500-3,000+", budgetRank: 1, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Бюджетный вариант для focused smart contract audit. Хорошо подходит как первый внешний PDF-отчет." },
  ...
  { id: "securedapp", name: "SecureDApp", country: "India", region: "Asia", site: "https://securedapp.io", contact: "Форма на сайте", budget: "$2,000-5,000", budgetRank: 4, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Blockchain security и smart contract audit. Запросить focused scope по Transport/Daily/Lockup." },
  { id: "quest-glt", name: "Quest GLT", country: "USA / UAE / India / Canada", region: "US / Asia / UAE", site: "https://www.questglt.com/services/smart-contract-audit", contact: "Форма на сайте", budget: "$3,000-5,000", budgetRank: 5, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Affordable blockchain team. Хорошо писать с четким scope и просьбой не оценивать бизнес-модель." },
  { id: "credshields", name: "CredShields", country: "Singapore / India", region: "Asia", site: "https://credshields.com", contact: "Форма на сайте", budget: "$3,000-5,000", budgetRank: 6, priority: "1. Писать первым", status: "Не писали", response: "", notes: "SolidityScan + human audit. Нормальный кандидат для focused audit до $5k." },
  { id: "immunebytes", name: "ImmuneBytes", country: "India", region: "Asia", site: "https://www.immunebytes.com", contact: "Форма на сайте", budget: "$3,000-5,000", budgetRank: 7, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Индийская Web3 security команда. Запросить цену на BSC/Solidity audit." },
  { id: "antier", name: "Antier Solutions", country: "India", region: "Asia", site: "https://www.antier.com/smart-contract-audit/", contact: "Форма / WhatsApp / Telegram на сайте", budget: "$3,000-5,000", budgetRank: 8, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Заявляют affordable smart contract audit. Может быть больше dev-команда, чем pure security firm." },
  ...
  { id: "katchin-tech", name: "Katchin Tech", country: "India", region: "Asia", site: "https://clutch.co/in/developers/blockchain/smart-contract-audit", contact: "Через Clutch / поиск сайта", budget: "$1,000+", budgetRank: 10, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Найдено через Clutch. Проверить сайт и попросить focused Solidity/BSC quote." },
  { id: "ancilar", name: "Ancilar", country: "India", region: "Asia", site: "https://clutch.co/in/developers/blockchain/smart-contract-audit", contact: "Через Clutch / поиск сайта", budget: "$1,000+", budgetRank: 11, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Blockchain focus, smart contract auditing. Хороший бюджетный lead." },
  { id: "qubit3", name: "Qubit3 Technologies", country: "India", region: "Asia", site: "https://clutch.co/in/developers/blockchain/smart-contract-audit", contact: "Через Clutch / поиск сайта", budget: "$1,000+", budgetRank: 12, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Бюджетный кандидат. Проверить качество и примеры отчетов." },
  { id: "zaap", name: "Zaap Solutions", country: "India", region: "Asia", site: "https://clutch.co/in/developers/blockchain/smart-contract-audit", contact: "Через Clutch / поиск сайта", budget: "$1,000+", budgetRank: 13, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Небольшая команда, может дать дешевый quote. Нужна проверка экспертизы." },
  { id: "privacy-ninja", name: "Privacy Ninja", country: "Singapore", region: "Asia", site: "https://www.privacy.com.sg/smart-contract-audit/", contact: "Форма на сайте", budget: "$3,000-5,000", budgetRank: 14, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Сингапурский вариант, заявляют affordability и price match." },
  ...
  { id: "a2co", name: "A2CO", country: "USA", region: "US", site: "https://a2co.com/services/smart-contract-audits/", contact: "Форма на сайте", budget: "$4,000-7,000", budgetRank: 17, priority: "2. Запас", status: "Не писали", response: "", notes: "Smart contract audits и security review. Может быть выше бюджета, но написать можно." },
  { id: "assure-defi", name: "Assure DeFi", country: "USA", region: "US", site: "https://www.assuredefi.com/code-audit", contact: "Форма на сайте", budget: "$4,000-8,000", budgetRank: 18, priority: "2. Запас", status: "Не писали", response: "", notes: "500+ audits по их заявлению. Уточнить цену и глубину review." },
  ...
  { id: "astrasec-ai", name: "AstraSec AI", country: "International / Asia", region: "Asia / Global", site: "https://astrasec.ai", contact: "Форма на сайте / X", budget: "$2,000-6,000", budgetRank: 20, priority: "2. Запас", status: "Не писали", response: "", notes: "AI smart contract security. Проверить, это полноценный аудит или только scanner." },
  ...
  { id: "quill-audits", name: "QuillAudits", country: "India", region: "Asia", site: "https://www.quillaudits.com", contact: "Форма на сайте", budget: "$5,000+", budgetRank: 23, priority: "2. Запас", status: "Не писали", response: "", notes: "Более известная индийская команда. Может быть дороже, но стоит запросить focused audit." },
  ...
  { id: "smartcontractaudits-marketplace", name: "SmartContractAudits marketplace", country: "Marketplace", region: "Global", site: "https://www.smartcontractaudits.com", contact: "Request audit form", budget: "$3,000-10,000", budgetRank: 26, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Не компания, а площадка: можно получить предложения от нескольких аудиторов. Полезно для бюджета до $5k." },
  ...
  { id: "fast-interfi-network", name: "InterFi Network", country: "International / non-EU lead", region: "Global", site: "https://www.interfi.network", contact: "Форма на сайте", budget: "$300 базово; request fixed quote <= $3k", budgetRank: 101, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. Лучший первый кандидат под наш бюджет: на сайте указано, что standard audit costs around $300; есть turnaround 4/3/2 days. Попросить focused audit Audit V3: LockupFlow, DailyFlow, Transport, PositionHandler, BSC/Pancake V3, срок 5 рабочих дней, cap $3k." },
  { id: "fast-quest-glt", name: "Quest GLT", country: "USA / UAE / India / Canada", region: "US / Asia / UAE", site: "https://www.questglt.com/services/smart-contract-audit", contact: "Форма на сайте", budget: "Публично affordable; request <= $3k", budgetRank: 102, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. На странице заявляют fast/reliable audits at reasonable prices и transparent pricing. Не Европа. Запросить 1-week focused Solidity/BSC audit, не полный protocol audit." },
  { id: "fast-securedapp", name: "SecureDApp", country: "India", region: "Asia", site: "https://securedapp.io", contact: "Request quote / форма", budget: "Request fixed quote <= $3k", budgetRank: 103, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. Индийский blockchain security lead. Есть smart contract audit / security services и quote flow. Писать с жестким scope: 4 core contracts, audit report, 5-7 days, budget cap $3k." },
  { id: "fast-credshields", name: "CredShields", country: "Singapore / India", region: "Asia", site: "https://credshields.com", contact: "Форма на сайте", budget: "Request fixed quote <= $3k", budgetRank: 104, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. Asia lead, SolidityScan + human audit направление. Уточнить, могут ли сделать manual focused review до недели и до $3k; не брать только scanner без human report." },
  { id: "fast-immunebytes", name: "ImmuneBytes", country: "India", region: "Asia", site: "https://www.immunebytes.com", contact: "Форма на сайте", budget: "Request fixed quote <= $3k", budgetRank: 105, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. Индийская Web3 security команда. Подходит как бюджетный non-European вариант; запросить конкретно BSC/Pancake V3 accounting + owner/backend risks." },
  { id: "fast-antier", name: "Antier Solutions", country: "India", region: "Asia", site: "https://www.antier.com/smart-contract-audit/", contact: "Форма / WhatsApp / Telegram на сайте", budget: "Affordable по сайту; request <= $3k", budgetRank: 106, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. На сайте заявляют affordable market prices. Больше dev/vendor, чем pure audit firm, но может быстро дать quote. Требовать именно security report, severity table и remediation call." },
  { id: "fast-privacy-ninja", name: "Privacy Ninja", country: "Singapore", region: "Asia", site: "https://www.privacy.com.sg/smart-contract-audit/", contact: "Форма на сайте", budget: "Request fixed quote <= $3k", budgetRank: 107, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. Сингапур, не Европа. Есть smart contract audit service. Уточнить глубину Solidity/EVM экспертизы и срок до 1 недели." },
  { id: "fast-astrasec-ai", name: "AstraSec AI", country: "International / Asia lead", region: "Asia / Global", site: "https://astrasec.ai", contact: "Форма на сайте / X", budget: "$2k-3k target; verify", budgetRank: 108, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. AI/security lead. Подходит только если дадут human-reviewed PDF, а не просто scanner output. Попросить quick triage + manual review до $3k." },
  { id: "fast-smartcontractaudits-marketplace", name: "SmartContractAudits marketplace", country: "Marketplace", region: "Global", site: "https://www.smartcontractaudits.com", contact: "Request audit form", budget: "Получить bids <= $3k", budgetRank: 109, priority: "1. Писать первым", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. Не компания, а площадка. Использовать, чтобы получить предложения от non-European independent auditors. В заявке прямо указать: exclude Europe, deadline 7 days, budget cap $3k." },
  { id: "fast-katchin-tech", name: "Katchin Tech", country: "India", region: "Asia", site: "https://clutch.co/in/developers/blockchain/smart-contract-audit", contact: "Через Clutch / найти сайт", budget: "Clutch lead from $1k; verify <= $3k", budgetRank: 110, priority: "2. Запас", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. Индийский бюджетный lead из Clutch smart contract audit категории. Нужно проверить реальный сайт, портфолио Solidity и попросить быстрый quote." },
  { id: "fast-ancilar", name: "Ancilar", country: "India", region: "Asia", site: "https://clutch.co/in/developers/blockchain/smart-contract-audit", contact: "Через Clutch / найти сайт", budget: "Clutch lead from $1k; verify <= $3k", budgetRank: 111, priority: "2. Запас", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. Бюджетный India lead. Использовать как запас, если первые профильные security-команды не уложатся в $3k/неделю." },
  { id: "fast-qubit3", name: "Qubit3 Technologies", country: "India", region: "Asia", site: "https://clutch.co/in/developers/blockchain/smart-contract-audit", contact: "Через Clutch / найти сайт", budget: "Clutch lead from $1k; verify <= $3k", budgetRank: 112, priority: "2. Запас", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. Бюджетный India lead. Нужна проверка качества отчетов; просить sample audit report до оплаты." },
  { id: "fast-zaap", name: "Zaap Solutions", country: "India", region: "Asia", site: "https://clutch.co/in/developers/blockchain/smart-contract-audit", contact: "Через Clutch / найти сайт", budget: "Clutch lead from $1k; verify <= $3k", budgetRank: 113, priority: "2. Запас", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. Небольшая India-команда, потенциально дешевая. Подходит только для дополнительного review, не как сильный репутационный аудит." },
  { id: "fast-a2co", name: "A2CO", country: "USA", region: "US", site: "https://a2co.com/services/smart-contract-audits/", contact: "Форма на сайте", budget: "Request narrow quote <= $3k", budgetRank: 114, priority: "2. Запас", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. US lead. Может выйти дороже, но стоит запросить narrow 4-contract review с готовым Hermes report as context." },
  { id: "fast-assure-defi", name: "Assure DeFi", country: "USA", region: "US", site: "https://www.assuredefi.com/code-audit", contact: "Форма на сайте", budget: "Request narrow quote <= $3k", budgetRank: 115, priority: "2. Запас", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. US lead с опытом audit/KYC. Вероятно выше бюджета, но можно попросить fast focused review, так как scope маленький." },
  { id: "fast-quill-audits", name: "QuillAudits", country: "India", region: "Asia", site: "https://www.quillaudits.com", contact: "Форма на сайте", budget: "Likely >$3k; ask mini-audit", budgetRank: 116, priority: "2. Запас", status: "Не писали", response: "", notes: "Fast audit shortlist <= $3k / <= 7 days. Более известная индийская команда. Может быть дороже $3k, но не Европа и хороший запасной вариант, если согласятся на mini-audit до недели." },
];
