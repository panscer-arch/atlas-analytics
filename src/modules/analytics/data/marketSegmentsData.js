...
const marketSegmentRows = [
  ...
  ["marketplace-entrepreneurs", "Предприниматели маркетплейсов после потери товара или оборота", "Селлеры Wildberries, Ozon, Яндекс Маркета и других площадок, чей товар, склад или оборотный капитал пострадали из-за пожара, повреждения склада, логистического сбоя или блокировки поставок", "Привыкли зарабатывать на продажах, трафике, повторных покупках и управлении командой; ищут новые направления для применения этих навыков без физического товарного запаса.", "Высокая", "Telegram- и VK-сообщества селлеров, YouTube-каналы о маркетплейсах, профильные медиа, клубы предпринимателей, конференции и чаты пострадавших селлеров в России и СНГ", "Тёплый", "Высокий", "2. Следом", "Angle: «Товар можно потерять. Предпринимательский опыт остаётся». Предлагать не «вернуть потери», а изучить цифровую Web3-модель без складских запасов и применить навыки продаж, трафика и построения команды. CTA: изучить механику Smart Cycle, публичные on-chain данные и риски до участия. Нельзя обещать возврат потерь, гарантированный доход, отсутствие риска или превосходство Atlas над обычным бизнесом.", "Готовить angle"],
];
