...
const forecastColumns = [
  ["period", "Период"],
  ["scenario", "Сценарий"],
  ["incomingPlan", "Входящий поток — план"],
  ["incomingFact", "Входящий поток — факт"],
  ["planCompletion", "Выполнение плана, %"],
  ["newWalletsPlan", "Новые активные кошельки — план"],
  ["newWalletsFact", "Новые активные кошельки — факт"],
  ["averageCycle", "Средний цикл, $"],
  ["cycleStartsPlan", "Запуски циклов — план"],
  ["repeatRate", "Повторные циклы, %"],
  ["outgoingForecast", "Исходящий поток — прогноз"],
  ["lpTarget", "Целевой LP"],
  ["reserveMinimum", "Минимальный резерв"],
  ["netFlowFact", "Чистый поток — факт"],
  ["riskAction", "Главный риск / действие"],
];

const forecastRows = [
  ["Август 2026", "Базовый", "1.500.000", "", "", "900", "", "$330", "4.500", "", "", "", "", "", ""],
  ["Сентябрь 2026", "Базовый", "2.300.000", "", "", "1.350", "", "$330", "6.750", "", "", "$700.000", "", "", ""],
  ["Октябрь 2026", "Базовый", "3.400.000", "", "", "2.040", "", "$330", "10.140", "", "", "$1.000.000", "", "", ""],
  ["Ноябрь 2026", "Базовый", "5.100.000", "", "", "3.030", "", "$330", "15.180", "", "", "$1.400.000", "", "", ""],
  ["Декабрь 2026", "Базовый", "7.600.000", "", "", "4.560", "", "$330", "22.770", "", "", "$2.000.000", "", "", ""],
  ["Январь 2027", "Базовый", "11.400.000", "", "", "6.840", "", "$330", "34.170", "", "", "$2.800.000", "", "", ""],
  ["Февраль 2027", "Базовый", "17.100.000", "", "", "10.260", "", "$330", "51.270", "", "", "$4.000.000", "", "", ""],
  ["Март 2027", "Базовый", "25.600.000", "", "", "15.390", "", "$330", "76.890", "", "", "$6.000.000", "", "", ""],
  ["Апрель 2027", "Базовый", "38.400.000", "", "", "23.070", "", "$330", "115.320", "", "", "", "", "", ""],
  ["Май 2027", "Базовый", "57.700.000", "", "", "34.590", "", "$330", "173.010", "", "", "", "", "", ""],
  ["Июнь 2027", "Базовый", "86.500.000", "", "", "51.900", "", "$330", "259.500", "", "", "", "", "", ""],
  ["Июль 2027", "Базовый", "129.700.000", "", "", "77.850", "", "$330", "389.250", "", "", "", "", "", ""],
];
...
const seedDocument = {
  ...
  tables: [
    ...
    },
    {
      id: "forecast",
      title: "Прогноз GPT",
      sourceRange: "Рабочая модель SuperSus",
      columns: buildColumns(forecastColumns),
      rows: buildRows("forecast", forecastRows, forecastColumns),
      notes: [
        { id: "forecast-note-1", text: "План и факт заполняются вручную: автоматической синхронизации с Google-таблицей нет." },
        { id: "forecast-note-2", text: "Для сравнения сценариев продублируйте месяц и выберите: консервативный, базовый или ускоренный." },
        { id: "forecast-note-3", text: "Входящий поток не равен прибыли. Отдельно контролируйте исходящий поток, LP и минимальный резерв." },
        { id: "forecast-note-4", text: "Главные сигналы роста: активные кошельки, повторные циклы, выполнение плана и чистый поток." },
      ],
    },
  ],
};
...
export function validateTablesDocument(value) {
  ...
  if (!tableIds.has("growth") || !tableIds.has("liquidity") || !tableIds.has("forecast")) {
    return "Документ должен содержать таблицы роста, ликвидности и прогноза.";
  }
  return "";
}
