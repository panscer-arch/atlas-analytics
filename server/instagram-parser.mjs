...
const ASIA_DISCOVERY_SEEDS = [
  ...
  {
    username: "ericworre",
    displayName: "Eric Worre",
    country: "Singapore / Global",
    language: "en",
    segment: "cryptoMlm",
    bio: "Network marketing trainer / public Instagram snippets include Singapore and network marketing content.",
    relevance: "High-signal network marketing education account; useful as a reference node for MLM leader discovery.",
  },
  {
    username: "digitalexchangeid",
    displayName: "DigitalExchange.id",
    country: "Indonesia / Asia",
    language: "id",
    segment: "tokenPresale",
    bio: "Indonesian crypto account; public snippets mention airdrop hunter community calls.",
    relevance: "Indonesia crypto / airdrop audience signal for Web3 outreach and media mapping.",
  },
  {
    username: "kangsai__",
    displayName: "Kangsai",
    ...
    language: "id/en",
    segment: "tokenPresale",
    bio: "Crypto trader, crypto enthusiast, airdrop hunter and community ambassador public profile signal.",
    relevance: "Airdrop hunter + crypto community profile in Asia; candidate for manual Web3 community validation.",
  },
  {
    username: "tokenomyairdrop",
    displayName: "Tokenomy Airdrop",
    country: "Indonesia / Asia",
    language: "id",
    segment: "tokenPresale",
    bio: "Airdrop-focused Indonesian crypto account.",
    relevance: "Airdrop audience source in Indonesia; useful for token/quest community research.",
  },
  {
    username: "dxn.philippines",
    displayName: "DXN Philippines",
    country: "Philippines / Asia",
    language: "en",
    segment: "cryptoMlm",
    bio: "Direct selling Philippines signal; public snippets reference DSAP / direct selling association context.",
    relevance: "Direct-selling company signal in the Philippines; useful for regional MLM landscape mapping.",
  },
  {
    username: "direct.selling.businesss",
    displayName: "Direct Selling Business",
    country: "Philippines / Asia",
    language: "en",
    segment: "cryptoMlm",
    bio: "Direct-selling business signal from public Instagram snippets around Philippines direct selling.",
    relevance: "Direct-selling / network marketing profile candidate for manual validation.",
  },
];
