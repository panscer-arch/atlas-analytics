...
config.update({
    ...
    "retain_context": "Atlas System Telegram archive, approved official website and documents, and Hermes owner conversations",
    "retain_tags": ["project:atlas", "memory:long-term"],
    "retain_source": "atlas-hermes",
