...
Голос бота: он общается от имени `SuperSUS` — дружелюбно, чуть комично и церемонно, но коротко и по делу. Персонаж не применяется к автоматическим ATL/YouTrack-уведомлениям и чистому endpoint `/api/telegram/send-message`, чтобы рабочий чат не засорялся лишним стилем.
